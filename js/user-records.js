...
class UserRecordsSection extends React.Component {
    constructor() {
        ...
        this.tableHeaderOptions = [{ style: { width: "35%" }, name: "Tên / Name" }, { style: { width: "25%" }, name: "Mã số / IC" }, { style: { width: "15%" }, name: "Thời gian mượn / Borrow Times" }, { style: { width: "20%" }, name: "Lần cuối thấy / Last Seen" }, { style: { width: "5%" }, name: "" }];
        this.delOptions = {
            del: true,
            db: "User",
            queryCol: 2
    ...
    render() {
        ...
        return React.createElement(
            ...
            React.createElement(AddUser, { addedUser: this.addedUser })
        );
    }
}
