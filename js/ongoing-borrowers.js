...
class OngoingBorrowersSection extends React.Component {
    constructor() {
        ...
        this.tableHeaderOptions = [{ style: { width: "15%" }, name: "Tên / Name" }, { style: { width: "15%" }, name: "Mã số / IC" }, { style: { width: "30%" }, name: "Sách đang được mượn / Borrowed Book" }, { style: { width: "20%" }, name: "Ngày mượn / Date of Borrow" }, { style: { width: "15%" }, name: "Thời hạn mượn sách / Due Date" }, { style: { width: "5%" }, name: "" }];
        this.delOptions = {
            del: false
        };
        this.pageLimit = 3;
    ...
    render() {
        ...
        return React.createElement(
            'div',
            null,
            React.createElement(SearchBar, { placeholder: 'Search by name or ic... / T\xECm ki\u1EBFm b\u1EB1ng t\xEAn ho\u1EB7c m\xE3 s\u1ED1 ...', handleKeyUp: this.handleKeyUp }),
            React.createElement(Table, { subsetData: subsetData, delOptions: delOptions, tableHeaderOptions: tableHeaderOptions }),
...
ReactDOM.render(React.createElement(OngoingBorrowersSection, null), document.getElementById("ongoing-borrowers-root"));