  ...
  render() {
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          'a',
          { className: 'pagination-previous', onClick: currentPage == 1 ? null : this.handleMoveLeft, disabled: currentPage == 1 },
          'Previous'
        ),
        React.createElement(
          'a',
          { className: 'pagination-next', onClick: currentPage == this.totalPages ? null : this.handleMoveRight, disabled: currentPage == this.totalPages },
          'Next'
        ),
        React.createElement(
          'ul',
          ...
          pages.map((page, index) => {
            ...
            if (page === LEFT_PAGE) return React.createElement(
              'li',
              { key: index },
              React.createElement(
                'span',
            ...
            if (page === RIGHT_PAGE) return React.createElement(
              'li',
              { key: index },
              React.createElement(
                'span',
            ...
            return React.createElement(
              ...
              React.createElement(
                'a',
                { className: `pagination-link${currentPage === page ? ' is-current' : ''}`, href: '#', onClick: this.handleClick(page) },
                page
              )
            );
          })
