...
module.exports = {
  up: function (queryInterface, Sequelize) {
    var sequelize = queryInterface.sequelize,
        searchFields = ['label', 'title', 'category', 'author'],
        vectorName = "BookText",
        tableName = "Books";
    ...
    return sequelize
      ...
      .then(function() {
        ...
        return sequelize
                .query('CREATE INDEX book_search_idx ON "' + tableName + '" USING gin("' + vectorName + '");')
                .catch(console.log);
      }).then(function() {
        console.log("Index created: Adding trigger");
        return sequelize
                .query('CREATE TRIGGER book_vector_update BEFORE INSERT OR UPDATE ON "' + tableName + '" FOR EACH ROW EXECUTE PROCEDURE tsvector_update_trigger("' + vectorName + '", \'pg_catalog.english\', ' + searchFields.join(', ') + ')')
                .catch(console.log);
      }).then(function() {
  ...
  down: function (queryInterface, Sequelize) {
    ...
    return sequelize
      ...
      .then(function(){
        ...
        return sequelize
                .query("DROP INDEX book_search_idx")
                .catch(console.log)
      }).then(function(){
